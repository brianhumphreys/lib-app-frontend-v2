    ...
    <div class="container">
        <header class="library__profiles__top">
            <div class="library__title__header">
                <h1 class="library__title"><span class="library__title--top">Admin Dashboard</span> </h1>
            </div>
        ...
        <main class="library__profiles">
            ...
            <article id="admin-book-row" v-for="book in books" class="library__profile"
                v-on:click="() => routeToBook(book.ID)">
                ...
                <div class="library__info-group">
                    <span id="test-admin-book-title" class="library__book-title">{{ book.title }}</span>
