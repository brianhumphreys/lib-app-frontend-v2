    ...
    <div class="card card-container">
      ...
      <Form @submit="handleLogin" :validation-schema="schema">
        <div id="email-field" class="form-group">
          ...
          <Field id="email-input-field" name="email" type="text" class="form-control" />
        ...
        <div class="form-group">
          <button id="login-button" class="btn btn-primary btn-block" :disabled="loading">
            <span
              v-show="loading"
              class="spinner-border spinner-border-sm"
            ></span>
            <span id="test-login-button">Login</span>
          </button>
        </div>
